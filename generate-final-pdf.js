...
const pdfPath = path.join(outputDir, 'freelance-to-passive-blueprint-FINAL.pdf');
...
async function generatePDF() {
  ...
  // Copy to Windows
  const winPath = 'C:\\Users\\roger\\passive-funnel\\freelance-to-passive-blueprint-FINAL.pdf';
